defmodule LatticeStripe.Testing.Fixtures.Quote do
  @moduledoc """
  Canonical raw fixtures for Stripe Quote objects.
  """

  @spec quote_json(map()) :: map()
  ...
  @spec accepted_quote_json(map()) :: map()
  ...
  @spec canceled_quote_json(map()) :: map()
  ...
  @spec quote_line_item_json(map()) :: map()
  ...
  @spec quote_computed_upfront_line_item_json(map()) :: map()
  ...
  @spec expanded_quote_json(map()) :: map()
