defmodule LatticeStripe.Testing.Fixtures.Dispute do
  @moduledoc """
  Canonical raw fixtures for Stripe Dispute objects.
  """

  @spec dispute_json(map()) :: map()
  ...
  @spec dispute_evidence_json(map()) :: map()
  ...
  @spec dispute_evidence_details_json(map()) :: map()
