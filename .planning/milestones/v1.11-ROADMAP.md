...
- ✅ **v1.11 — Reader-First Quality Closure** — Phases 68-73 (shipped 2026-08-25; final package 2.2.2)
...
**Success Criteria** (what must be TRUE):
  ...
  3. The final 2.2.x quality patch is published and verifiable on GitHub Releases, Hex.pm, and HexDocs from the exact green release SHA.
