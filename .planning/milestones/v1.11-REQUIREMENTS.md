# Requirements Archive: v1.11 Reader-First Quality Closure
...
**Original target package:** 2.2.1; final audit-remediation patch: 2.2.2
...
- [x] **CLOSE-03** — The final 2.2.x quality patch is published and verified on GitHub Releases, Hex.pm, and HexDocs from the exact green release SHA.
