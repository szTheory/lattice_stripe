...
- [x] **Phase 19: Cross-cutting Polish & v1.0 Release** - Final docs pass, release cut, accumulated cleanup (completed 2026-04-13)
...
Plans:
- [x] 19-01-api-audit-modgroups-PLAN.md — @moduledoc false flip + mix.exs nine-group D-19 layout (D-04, D-05, D-19, D-20)
- [x] 19-02-guides-editorial-PLAN.md — connect.md split + api_stability.md + Phase 10 cross-links + :extras reorder (D-07, D-08, D-15, D-16, D-17)
- [x] 19-03-readme-quickstart-test-PLAN.md — README restructure + readme_test.exs Wave 0 (D-21, D-22, D-23, D-24)
- [x] 19-04-release-please-1-0-PLAN.md — release-as 1.0.0 + CHANGELOG highlights + release cut + post-release cleanup (D-09, D-10, D-11, D-12, D-14)
