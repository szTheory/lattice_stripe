...
- [x] 48-04-PLAN.md — Docs-truth regression: 3A guide content locks + 3B install-line canary + 3C ExDoc placement extension + 3D cross-link graph locks (depends on 48-01, 48-02, 48-03)
