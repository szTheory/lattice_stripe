...
- [ ] **Phase 52: Charge Surface Expansion** — Expand retrieve-only Charge module to list/search/update/capture parity with sibling resources; integration tests + docs-truth four-surface triangulation.
...
|-------|-----------|----------------|--------|-----------|
| 52. Charge Surface Expansion | v1.7 | 0/TBD | Not started | — |
