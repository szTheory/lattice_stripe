...
- [ ] `scripts/verify_meter_endpoints.exs` — stripe-mock endpoint availability probe for all 7 metering endpoints
- [ ] `test/lattice_stripe/billing/meter_test.exs` — unit stubs for METER-01..02
- [ ] `test/lattice_stripe/billing/meter_integration_test.exs` — integration stubs for METER-03..08
- [ ] `test/lattice_stripe/billing/meter_guards_test.exs` — stubs for GUARD-01, GUARD-03
- [ ] `test/lattice_stripe/billing/meter_event_test.exs` — stubs for EVENT-01..03, GUARD-02
- [ ] `test/lattice_stripe/billing/meter_event_adjustment_test.exs` — stubs for EVENT-04..05
- [ ] `test/support/meter_fixtures.ex` — shared Stripe payload fixtures (meter, meter_event, meter_event_adjustment) — matches existing test/support pattern
