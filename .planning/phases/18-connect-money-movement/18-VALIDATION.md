...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| TBD | TBD | TBD | CNCT-02..05 | — | PII hide-list on BankAccount/Card | unit | `mix test test/lattice_stripe/...` | ❌ W0 | ⬜ pending |
...
- [ ] Wave 0 covers all MISSING references (none expected for Phase 18)
- [ ] No watch-mode flags
