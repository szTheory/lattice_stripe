...
## What's next: money movement

This guide covers account lifecycle and onboarding. **External account
attachment, Transfers, Payouts, and Balance are covered in Phase 18** — see
the [Payouts guide](payouts.html) when it ships.
