...
## [1.8.0](https://github.com/szTheory/lattice_stripe/compare/v1.7.1...v1.8.0) (2026-05-28)
...
* **32-01:** add MultipartEncoder module with RFC 2046 multipart/form-data encoding ([1beb046](https://github.com/szTheory/lattice_stripe/commit/1beb0460d10fd3732768343ac6be9fc4e73768ee))
* **32-01:** extend Config/Client/Response for file transport and add fixture builders ([19f489d](https://github.com/szTheory/lattice_stripe/commit/19f489d17d71ae8e60c86fff893870f26fae6e86))
* **32-02:** add Client.upload/4 and Client.download/2 transport functions ([9ed080a](https://github.com/szTheory/lattice_stripe/commit/9ed080ad58c1ef11010dc46b78054c5c4abffa1f))
* **32-03:** add File and FileLink resource modules with ObjectTypes registration ([60a5581](https://github.com/szTheory/lattice_stripe/commit/60a5581d27b478dc8c1855fcc127f81a2c32a8cd))
* **37-01:** add explicit testing wrappers ([1672a77](https://github.com/szTheory/lattice_stripe/commit/1672a77dc529c601bc848ac1cb92aab85f47b0c2))
* **37-01:** publish v1.3 fixture builders ([c86090f](https://github.com/szTheory/lattice_stripe/commit/c86090f753729964d0a940e5e34232a671b3d943))
* **41.1-01:** add quote follow-through probe ([c019cd1](https://github.com/szTheory/lattice_stripe/commit/c019cd15eb7933b21ff36227cb55c21d99d39b66))
* **47-01:** add EventNotification struct + RelatedObject sub-struct + fixture ([41bab90](https://github.com/szTheory/lattice_stripe/commit/41bab906b791c8aef372f186122b18f0d70ef6dd))
* **47-01:** extend Event with related_object + add ObjectTypes.fetch_module/1 + tests ([60c53a9](https://github.com/szTheory/lattice_stripe/commit/60c53a91658e0d9baddfd4a0d6950d81a3566681))
* **47-02:** add Webhook.parse_event_notification/4 + bang variant for thin events ([448bbe9](https://github.com/szTheory/lattice_stripe/commit/448bbe9e94036bcb926db84aef646a12bbf1dcee))
* **47-04:** add fetch_event/3 + fetch_event!/3 with v2-aware retrieve ([44f7868](https://github.com/szTheory/lattice_stripe/commit/44f7868c80f6057feda79cd9c55c910a277b73fb))
* **47-04:** add fetch_related_object/3 + bang variant with D-05 typed gate ([c0b4cce](https://github.com/szTheory/lattice_stripe/commit/c0b4cce1816ee831c24c224b1c3bfa58b6376162))
* **47-05:** add Testing.generate_thin_event_payload/3 + event_notification/1 ([60f010d](https://github.com/szTheory/lattice_stripe/commit/60f010da299dc32a5e34502a56ef4898de3b0a72))
* **48-05:** add thin_event_test.exs — chained roundtrip integration suite (VERIFY-03) ([5df9b5d](https://github.com/szTheory/lattice_stripe/commit/5df9b5dd5759ab5854db2bda7a677614415dbf19))
* **49-01:** add Tax.Calculation resource and nested structs lib/lattice_stripe/tax/ lib/lattice_stripe/object_types.ex test/support/fixtures/tax_calculation.ex test/lattice_stripe/tax/calculation_test.exs test/lattice_stripe/object_types_test.exs ([1d4fc21](https://github.com/szTheory/lattice_stripe/commit/1d4fc2141b62b0756dd117ee0f79198f182a20cd))
* **49-02:** add Tax.Transaction resource and moduledocs lib/lattice_stripe/tax/ lib/lattice_stripe/object_types.ex test/support/fixtures/tax_transaction.ex test/lattice_stripe/tax/transaction_test.exs test/lattice_stripe/object_types_test.exs .planning/phases/49-tax-calculation-transaction-core/49-02-SUMMARY.md ([97d2983](https://github.com/szTheory/lattice_stripe/commit/97d29839fc7065f5a23158dd00c36bfd9abcbf8d))
* **50-01:** add Tax.Settings singleton with nested structs and tests ([e435977](https://github.com/szTheory/lattice_stripe/commit/e435977ddd2a629923ce9ce3931cd9eacc75561a))
* **50-02:** add Tax.Registration CRUDL with moduledocs and tests ([f514e4d](https://github.com/szTheory/lattice_stripe/commit/f514e4df33f2bf7232b31ecc9efb985ad8347f95))
* **51-01:** add LatticeStripe.TaxId dual-path CRUDL and ObjectTypes dispatch ([5760beb](https://github.com/szTheory/lattice_stripe/commit/5760beb7380563fabaf15ce4a62b5d93f7802ad6))
* **51-02:** promote Tax Testing fixtures and expand proof ([f1e49d8](https://github.com/szTheory/lattice_stripe/commit/f1e49d817ea58bfc9ef649375ad54f9359521a22))
* **51-03:** publish guides/tax.md and discovery wiring ([74a2766](https://github.com/szTheory/lattice_stripe/commit/74a2766b254f25838c580846657b77954ff83cdf))
* **51-04:** add Tax docs-truth regression locks ([8a0fbd5](https://github.com/szTheory/lattice_stripe/commit/8a0fbd5afcaccd8ff2635ad4156c37dc5b0d45f9))
* **52-01:** add Charge list/search/update/capture API ([5baf5c6](https://github.com/szTheory/lattice_stripe/commit/5baf5c6a13353fb8e49965b6e2991c9e9cdc3961))
* **52-01:** rewrite Charge moduledoc to PI-first narrative ([e3853da](https://github.com/szTheory/lattice_stripe/commit/e3853dac90d553a82848ad0bbbe1658ad762dd65))
* **54-01:** bump mix.exs version to 1.7.0 ([b736985](https://github.com/szTheory/lattice_stripe/commit/b7369850d8fa0538f8674af1a9f3a2da4e76ccfe))
* **54-01:** restructure CHANGELOG for v1.4–v1.7 Hex capstone ([b7330f0](https://github.com/szTheory/lattice_stripe/commit/b7330f0bb8fa0c14aca53502ccc90abd2ca5cd4e))
* **54-02:** lockstep install flip to ~&gt; 1.7 on public surfaces ([29bfc69](https://github.com/szTheory/lattice_stripe/commit/29bfc690af3912f2c79eb1ac6242d15116a411c1))
* publish flagship guides and docs truth updates ([54270e2](https://github.com/szTheory/lattice_stripe/commit/54270e2e20012a6cf140e2281fc88af6987567c0))
...
* **47-03:** reconcile WEBFIX-01 tolerance: 0 across code, plug, test ([8844163](https://github.com/szTheory/lattice_stripe/commit/8844163f5fcf8c62c5130665074b3a10910b7ab6))
* **48:** CR-01 pass full notif struct to claim/1 — fixes FunctionClauseError contract mismatch ([c7c3605](https://github.com/szTheory/lattice_stripe/commit/c7c3605f6e65304cb1aeefcf5ee9368c998e41f2))
* **48:** CR-02 replace compile-time [@secret](https://github.com/secret) module attr with runtime Application.fetch_env!/2 ([0ea7bd8](https://github.com/szTheory/lattice_stripe/commit/0ea7bd88701c77e9ac121535a97c4e0e5491faf3))
* **48:** WR-01 replace bare matches in dispatch_typed with case — prevents MatchError on fetch failure ([007c60b](https://github.com/szTheory/lattice_stripe/commit/007c60bd12e872c8d58acd2cfc31a071a4cf8ae0))
* **48:** WR-02 add EventNotification and RelatedObject to Webhooks docs group ([743d2ee](https://github.com/szTheory/lattice_stripe/commit/743d2ee37f34bfe7530c5876e4a41580b17b7c41))
* **51:** redact TaxId.Verification PII in Inspect output ([11ca590](https://github.com/szTheory/lattice_stripe/commit/11ca590b7e3e9f4475453f8afe656f8530068bbd))
* **51:** strip atom-key customer from nested TaxId create body ([ee305c8](https://github.com/szTheory/lattice_stripe/commit/ee305c8782e529881400b70ec5009de10f47c3ac))
* **58-03:** point adoption contract [@moduledoc](https://github.com/moduledoc) at v1.6 milestone audit ([005b77e](https://github.com/szTheory/lattice_stripe/commit/005b77e88d86f3a7b1950d337b914bce7556b36d))
* **docs:** Wedge A doc defect hotfixes with docs_truth locks ([e24e9a3](https://github.com/szTheory/lattice_stripe/commit/e24e9a3f41ad9b76dc42ee307f2732a474b86894))
